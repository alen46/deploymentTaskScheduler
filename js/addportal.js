$(document).ready(function(){
    ...
    $('#addportal').on('submit', function(e) {
        e.preventDefault(e);
        let pcheck = new FormData();
        pcheck.append('portal_name', $("#portal_name").val());
        pcheck.append('portal_url', $("#portal_url").val());
        pcheck.append('function',"pcheck");
        $.ajax({
            type: "POST",
            url: "main.php",
            data: pcheck,
            ...
            success: function(data) {
                console.log(data);
                if(data == 'ok'){
                    alert('portal name already exist');
                }else if(data == 'ok2'){
                    alert('portal url already exist');
                }else{
